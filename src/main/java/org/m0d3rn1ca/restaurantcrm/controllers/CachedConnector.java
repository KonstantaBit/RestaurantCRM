...
import org.m0d3rn1ca.restaurantcrm.CacheOperator;
...
public class CachedConnector {
    ...
    private String current_login = null;
    ...
    private CachedConnector() {
        try {
            ...
            alert.setTitle("Ошибка подключения к серверу");
            alert.setHeaderText("В данный момент сервер не отвечает...");
            alert.setContentText("Закройте приложение и попробуйте снова через 15 минут");
